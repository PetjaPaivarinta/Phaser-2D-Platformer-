class Menu extends Phaser.Scene {
    ...
    create ()
    {
        ...
        let text = this.add.text(this.sys.game.config.width / 2, this.sys.game.config.height / 2, 'Start', { fontFamily: 'Comic Sans', fontSize: '100px', color: '#FFF000'}).setOrigin(0.5).setDepth(1);
    }
